...
function multiplyHelper(x, y) {
  var botIndex = arguments.length <= 2 || arguments[2] === undefined ? y.length - 1 : arguments[2];
  var topIndex = arguments.length <= 3 || arguments[3] === undefined ? x.length - 1 : arguments[3];
  var rows = arguments.length <= 4 || arguments[4] === undefined ? [[]] : arguments[4];
  var round = arguments.length <= 5 || arguments[5] === undefined ? 0 : arguments[5];
  return (function () {
